...
public class VerticalExpandableLayout extends NestedScrollView {

    private final ArrayList<IndicatorListener> indicatorListeners = new ArrayList<>();
    ...
    public VerticalExpandableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public VerticalExpandableLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ExpandableLayout);
            if (a != null) {
                expanded = a.getBoolean(R.styleable.ExpandableLayout_expansion_expanded, expanded);
                a.recycle();
            }
        }
    }
    ...
    public interface Listener {
        void onExpansionChanged(VerticalExpandableLayout verticalExpandableLayout, boolean expanded);
    }

    public interface IndicatorListener {
        void onStartedExpand(VerticalExpandableLayout verticalExpandableLayout, boolean willExpand);
    }
}
...
public class Fab extends View {
	...
	final static OvershootInterpolator overshootInterpolator = new OvershootInterpolator();
	  ...
	  public Fab(Context context) {
	    ...
	    init(Color.parseColor("#ffaa00"));
	  }

	  public void setFabColor(int FloatingActionButtonColor) {
	    init(FloatingActionButtonColor);
	  }

	  public void setFabDrawable(Drawable FloatingActionButtonDrawable) {
	  ...
	  static public class Builder {
	    ...
	    public Fab create() {
	      ...
	      button.setFabDrawable(this.drawable);

...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            //ColorStateList tab_text_color=getResources().getColorStateList(R.color.tab_bg_colors);
            tabTitleView.setTextColor(tabTextColor);
            tabTitleView.setTextSize(14);
            tabTitleView.setTypeface(new Fonts(context,   AppConfig.getLocale(context).equals("fa")

...
public class HorizontalExpandableLayout extends HorizontalScrollView {
    ...
    public HorizontalExpandableLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface Listener {
        void onExpansionChanged(HorizontalExpandableLayout expansionLayout, boolean expanded);
    }

    public interface IndicatorListener {
        void onStartedExpand(HorizontalExpandableLayout expansionLayout, boolean willExpand);
    }
}
...
public class HeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private StickyListener mListener;
    private Integer mHeaderHeight;

    public HeaderItemDecoration(StickyListener listener) {
     ...
     *
     * @param parent ViewGroup: CustomRecyclerView in this case.
     */
    private void fixLayoutSize(ViewGroup parent, View view) {

        // Specs for parent (CustomRecyclerView)
